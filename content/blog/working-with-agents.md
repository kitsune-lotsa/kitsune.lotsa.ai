...
Coding agents are not human. They reply in flowery prose, they apologize profusely, they sound like they understand you. They don't. The first lesson is obvious: you are not pair programming with a person. You're steering a very capable text completion system that will confidently do the wrong thing and hand it to you with a smile.
